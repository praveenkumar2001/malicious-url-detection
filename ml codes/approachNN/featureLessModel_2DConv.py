...
from keras.layers import Input, ELU, Embedding, Convolution2D, MaxPooling2D, BatchNormalization, Reshape
...
# The main conv2D_model function, to create a complete 2D Conv architecture for
# prediction of URL being safe or unsafe	
def conv2D_model(max_len=75, emb_dim=25, max_vocab_len=100, W_reg=regularizers.l2(1e-4)):
    # Input
    ...
    res = Reshape((75,emb_dim,1))(emb)
    
    conv1 = Convolution2D(64, kernel_size=3, activation = "relu")(res)
    pool1 = MaxPooling2D(pool_size=(2,2))(conv1)
    conv2 = Convolution2D(32, kernel_size=2, activation = "relu")(pool1)
    pool2 = MaxPooling2D(pool_size=(2,2))(conv2)
    
    conv3 = Convolution2D(16, kernel_size=2, activation = "relu")(pool2)
    pool3 = MaxPooling2D(pool_size=(2,2))(conv3)
    
    #conv2 = Convolution2D(1, kernel_size=3, activation = "relu")(conv1)
    flat = Flatten()(pool3)
    
    dr1 = Dropout(0.5)(flat)
    
    hidden1 = Dense(350)(dr1)
    hidden1 = ELU()(hidden1)
    hidden1 = BatchNormalization(mode=0)(hidden1)
    hidden1 = Dropout(0.5)(hidden1)

    hidden2 = Dense(220)(hidden1)
    hidden2 = ELU()(hidden2)
...
wkdir = './model'
pb_filename = 'featureLessModel_2DConv.pb'
